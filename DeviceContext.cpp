...
void DeviceContext::setConstantBuffer2(VertexShader* vertex_shader, ConstantBuffer* buffer)
{
	m_device_context->VSSetConstantBuffers(1, 1, &buffer->m_buffer);
}

void DeviceContext::setConstantBuffer2(PixelShader* pixel_shader, ConstantBuffer* buffer)
{
